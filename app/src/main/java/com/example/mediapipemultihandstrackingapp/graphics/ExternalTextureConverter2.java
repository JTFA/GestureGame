...
public class ExternalTextureConverter2 implements TextureFrameProducer {
    ...
    private com.example.mediapipemultihandstrackingapp.graphics.ExternalTextureConverter2.RenderThread thread;

    public ExternalTextureConverter2(EGLContext parentContext, int numBuffers) {
        this.thread = new com.example.mediapipemultihandstrackingapp.graphics.ExternalTextureConverter2.RenderThread(parentContext, numBuffers);
    ...
    private static class RenderThread extends GlThread implements SurfaceTexture.OnFrameAvailableListener {
        ...
        private void updateOutputFrame(AppTextureFrame outputFrame) {
            ...
            EngineWrapper.getInstance().processFrame();
